...
public class Application02 {
    public static void main(String[] args) {
        ...
        * 따라서 Calendar 클래스를 이용해서 인스턴스를 생성하는것이 불가능하다.
        *
        * Calendar 클래스를 이용한 인스턴스 생성 방법에는 두가지가 있다
        * 1 getInstance() static 메소드를 이용하는 방법
        ...
        *
        ...
        // 그래고리안 캘린더 국제표준시의 생성자로 제공한다.

        GregorianCalendar gregorianCalendar = new GregorianCalendar();
        System.out.println(gregorianCalendar);
        // 년,월,일,시분,초정보를 이용해 인스턴스를 생성
        //2024 8월16일 14시 37분 00 초
        ...
        Calendar today = new GregorianCalendar(year, month, dayOfMonth, hour, min, sec);
        ...
        Date date2 = new Date(new GregorianCalendar(year, month, dayOfMonth, hour, min, sec).getTimeInMillis());
