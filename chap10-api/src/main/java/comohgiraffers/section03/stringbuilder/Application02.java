...
public class Application02 {
    public static void main(String[] args) {
        ...
        *
        ...
        System.out.println(sb1.capacity()); // 스프링빌더가기본적으로가지고있는 16

        /*
         apped():인자로 전달된 값을 문자열로 반환 후 기존 문자열의 마지막에 추가한다.
         기본 용량을 초과하는 경우 (기존문자열 +1)*2를하여  용량을 확장시킨다.
         */
        ...
        for(int i = 0; i < 50; i++)
        {
            ...
            System.out.println(sb1.hashCode()); //해보면 앎
        }
