...
public class Application02 {
    public static void main(String[] args) {
        ...
        bookList.add(new BookDTO(2,"목민심서","정약용",10000));
        bookList.add(new BookDTO(3,"동의보감","허준",20000));
        bookList.add(new BookDTO(4,"삼국사기","김부식",30000));
        bookList.add(new BookDTO(5,"삼국유사","일연",5043500));
        ...
        // 책제목을 기준으로 오름차순
        System.out.println("---------책제목 오름차순 정렬 ---------");
